...
<body>
    ...
    <label>Standar Data / Katalog Data:</label>
    <input type="text" name="standar_data">
    <label>Justifikasi / Catatan Penilai:</label>
    <textarea name="standar_data_justifikasi"></textarea>

    <label>Basis Data:</label>
    <input type="text" name="basis_data">
    <label>Justifikasi / Catatan Penilai:</label>
    <textarea name="basis_data_justifikasi"></textarea>

    <label>Aplikasi / Sistem Informasi:</label>
    <input type="text" name="aplikasi_informasi">
    <label>Justifikasi / Catatan Penilai:</label>
    <textarea name="aplikasi_informasi_justifikasi"></textarea>

    <!-- Subjek Distribusi / Publikasi Data -->
    <h3>Distribusi / Publikasi Data</h3>

    <label>Nilai:</label>
    <input type="number" name="publikasi_data_nilai" min="0" max="100">
    <label>Justifikasi / Catatan Penilai:</label>
    <textarea name="publikasi_data_justifikasi"></textarea>

    <!-- Subjek Integrasi Data -->
    <h3>Integrasi Data</h3>

    <label>Nilai:</label>
    <input type="number" name="integrasi_data_nilai" min="0" max="100">
    <label>Justifikasi / Catatan Penilai:</label>
    <textarea name="integrasi_data_justifikasi"></textarea>
